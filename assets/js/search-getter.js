        ...
        function (response) {
            if (response && !response.error) {
                ...
                for (var i = 0; i < ourdata.length; i++) {
                    ...
                    copied.innerHTML = '<div class="col-md-4 col-xs-6 botao"><img id="image" class="img-rounded" src="'+ourdata[i].picture.data.url+'"></div>'+
                                       '<div class="col-md-8 col-xs-6 botao" id="text">'+ourdata[i].name+'</div>';
